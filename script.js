...
function draw() {
  ...
  switch (screen) {
    ...
    case 4.5:
      showQuoteScreen();
      break; // Quote screen after shift request
    case 5:
      showJamalParty();
      break;
    case 5.5:
      showQuoteScreen();
      break; // Quote screen after party invite
    case 6:
      showMissingHomework();
      break;
    case 6.5:
      showQuoteScreen();
      break; // Quote screen after homework
    case 7:
      showDinerDrama();
      break;
    case 7.5:
      showQuoteScreen();
      break; // Quote screen after diner
    case 8:
      showDadLetter();
      break;
    case 9:
    ...
    case 9.5:
      showQuoteScreen();
      break; // Quote screen after Tae offer
    case 10:
      showLetterReflection();
      break;
    case 11:
      showKionevReturn();
      break;
    ...
    case 12.5:
      showQuoteScreen();
      break; // Quote screen after party decision
    case 13:
      showKionevTalk();
      break;
    case 14:
    ...
    case 14.5:
      showQuoteScreen();
      break; // Quote screen after money option
    case 15:
      showDebateFollowUp();
      break;
    case 15.5:
      showQuoteScreen();
      break; // Quote screen after debate followup
    case 16:
      showScholarshipStruggle();
      break;
    case 16.5:
      showQuoteScreen();
      break; // Quote screen after scholarship struggle
    case 17:
      showDadMessage();
      break;
    case 18:
    ...
    case 18.5:
      showQuoteScreen();
      break; // Quote screen after barbershop
    case 19:
      showSundayDecision();
      break;
    case 19.5:
      showQuoteScreen();
      break; // Quote screen after Sunday decision
    case 20:
      showMondayWakeUp();
      break;
    case 21:
    ...
    case 21.5:
      showQuoteScreen();
      break; // Quote screen after last shot
    case 22:
      showFinalReflection();
      break;
    case 23:
...
function showTitleScreen() {
  ...
  textSize(20);
  text(
    "A game about grit, struggle, and the fight to rise",
    width / 2,
    height / 2 - 60,
  );
...
function showShiftRequest() {
  ...
  if (choiceA.mouse.presses()) {
    applyChoice(
      "A",
      "Sometimes you gotta do what you gotta do to do what you wanna do. - Denzel Washington",
      5,
      0,
      0,
      10,
...
function showJamalParty() {
  ...
  if (choiceA.mouse.presses()) {
    applyChoice(
      "A",
      "I'm tryin' to make a dollar outta fifteen cents. - Tupac",
      0,
      10,
      5,
      0,
...
function showMissingHomework() {
  ...
  if (choiceA.mouse.presses()) {
    applyChoice(
      "A",
      "Even when I was wrong, I got my point across. - 50 Cent",
      10,
      -5,
      5,
      0,
  ...
  if (choiceB.mouse.presses()) {
    applyChoice(
      "B",
      "You gotta fake it till you make it... but don't fake too long. - Snoop Dogg",
      -5,
      0,
      -5,
      0,
  ...
  if (choiceC.mouse.presses()) {
    ...
    if (success) {
      applyChoice(
        "C",
        "Opportunity doesn't knock. You gotta break that door down. - The Rock",
        5,
        5,
        5,
        0,
      ...
      applyChoice(
        "C",
        "Sometimes teachers don't give second chances. - Common",
        0,
        -10,
        -5,
        0,
...
function showDinerDrama() {
  ...
  setupChoice(
    "Stay calm, finish shift",
    "Clap back, then walk away",
    "Leave mid-shift silently",
  );

  if (choiceA.mouse.presses()) {
    applyChoice(
      "A",
      "You gotta learn to survive in the game before you can win it. - Ice Cube",
      10,
      0,
      10,
      5,
  ...
  if (choiceB.mouse.presses()) {
    applyChoice(
      "B",
      "I'm not violent, but I will protect my energy. - Lauryn Hill",
      -5,
      0,
      10,
      0,
  ...
  if (choiceC.mouse.presses()) {
    applyChoice(
      "C",
      "Silence is sometimes the loudest statement. - Kendrick Lamar",
      0,
      0,
      10,
      -10,
...
function showTaeOffer() {
  ...
  if (choiceA.mouse.presses()) {
    applyChoice(
      "A",
      "You can't change the world if you're stuck in a cell. - Meek Mill",
      15,
      0,
      10,
      0,
  ...
  if (choiceB.mouse.presses()) {
    applyChoice(
      "B",
      "The streets raised me, but I'm tryna raise the bar. - J. Cole",
      -10,
      0,
      -10,
      20,
  ...
  if (choiceC.mouse.presses()) {
    applyChoice(
      "C",
      "Just because I don't say it, doesn't mean I'm not thinking 10 steps ahead. - Jay-Z",
      0,
      5,
      5,
      0,
...
function showPartyDecision() {
  ...
  setupChoice(
    "Stay home, work on essay",
    "Sneak out to party",
    "Text 'Can't tonight, fam stuff'",
  );

  if (choiceA.mouse.presses()) {
    applyChoice(
      "A",
      "I don't pop bottles, I plot problems and solve them. - J. Cole",
      5,
      15,
      10,
      0,
  ...
  if (choiceB.mouse.presses()) {
    applyChoice(
      "B",
      "Fun is temporary. Freedom is permanent. - Kendrick Lamar",
      -10,
      -5,
      -5,
      0,
  ...
  if (choiceC.mouse.presses()) {
    applyChoice(
      "C",
      "I don't need the spotlight, just the power to flip the switch. - Dave East",
      0,
      0,
      0,
      0,
...
function showMoneyOption() {
  ...
  if (choiceA.mouse.presses()) {
    applyChoice(
      "A",
      "Money ain't the goal. It's just the tool. - Nipsey Hussle",
      0,
      0,
      -5,
      20,
  ...
  if (choiceB.mouse.presses()) {
    applyChoice(
      "B",
      "You can't pour from an empty cup. - Erykah Badu",
      0,
      0,
      10,
      0,
  ...
  if (choiceC.mouse.presses()) {
    applyChoice(
      "C",
      "Balance ain't easy, but it's necessary. - Issa Rae",
      0,
      0,
      0,
      10,
...
function showDebateFollowUp() {
  ...
  if (choiceA.mouse.presses()) {
    applyChoice(
      "A",
      "Use your voice like it's the only weapon you've got. - Angela Davis",
      0,
      15,
      10,
      0,
  ...
  if (choiceB.mouse.presses()) {
    applyChoice(
      "B",
      "Saying no is self-care, not failure. - Solange",
      -5,
      0,
      10,
      0,
  ...
  if (choiceC.mouse.presses()) {
    applyChoice(
      "C",
      "You don't have to do it all to be doing enough. - Janelle Monáe",
      0,
      5,
      5,
      0,
...
function showScholarshipStruggle() {
  ...
  if (choiceB.mouse.presses()) {
    applyChoice(
      "B",
      "You can't edit a blank page. - Ava DuVernay",
      0,
      10,
      0,
      0,
  ...
  if (choiceC.mouse.presses()) {
    applyChoice(
      "C",
      "Sometimes you gotta go back to where it started. - Kendrick Lamar",
      5,
      5,
      10,
      0,
...
function showBarbershop() {
  ...
  if (choiceA.mouse.presses()) {
    applyChoice(
      "A",
      "Don't run from the block. Redesign it. - Killer Mike",
      -5,
      10,
      0,
      0,
  ...
  if (choiceB.mouse.presses()) {
    applyChoice(
      "B",
      "Be so dope they can't erase you. - Issa Rae",
      10,
      0,
      10,
      0,
...
function showSundayDecision() {
  ...
  setupChoice(
    "Stay up, finish essay",
    "Rest, I need to breathe",
    "Scroll, zone out, do nothing",
  );

  if (choiceA.mouse.presses()) {
    applyChoice(
      "A",
      "No sleep 'til the mission complete. - J. Cole",
      0,
      20,
      5,
      0,
  ...
  if (choiceC.mouse.presses()) {
    applyChoice(
      "C",
      "Distraction is the enemy of destiny. - Kendrick Lamar",
      -5,
      -15,
      -10,
      0,
...
function showLastShot() {
  ...
  setupChoice(
    "Submit scholarship, skip work",
    "Go to work, skip scholarship",
    "Try to do both",
  );
  ...
  if (choiceA.mouse.presses()) {
    applyChoice(
      "A",
      "If you don't bet on yourself, why would anyone else? - Diddy",
      0,
      15,
      10,
      -10,
  ...
  if (choiceB.mouse.presses()) {
    applyChoice(
      "B",
      "Sometimes responsibility wins. Don't forget your dreams. - Common",
      10,
      -5,
      5,
      15,
  ...
  if (choiceC.mouse.presses()) {
    ...
    if (totalStats >= 120) {
      ...
      applyChoice(
        "C",
        "Can't do everything perfectly. - Common",
        -5,
        -10,
        -5,
        0,
